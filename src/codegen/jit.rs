...
use crate::codegen::intrinsics::{
    ...
    intrinsic_arg_count, intrinsic_iter_for_each, intrinsic_iter_map, intrinsic_log,
    intrinsic_map_for_each, intrinsic_push_str, intrinsic_rc_clone, intrinsic_rc_drop,
    intrinsic_rc_new, intrinsic_spawn_thread, intrinsic_vec_pop, intrinsic_vec_push,
};
